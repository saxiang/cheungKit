...
- (void)setupDefault
{
    // 1.设置数据的默认值
    _title             = nil;
    _commonFont              = [UIFont systemFontOfSize:20];
	...
	self.itemColor = [UIColor lightGrayColor];
	self.lineView.backgroundColor = [UIColor clearColor];
	self.borderButtonColor    = [UIColor whiteColor];
...
- (void)setCommonFont:(UIFont *)font
{
    _commonFont = font;
...
- (UIPickerView *)pickerView
{
    if (!_pickerView) {
		...
		[[UIPickerView appearance] setTintColor:[UIColor blackColor]];
...
//        CGFloat leftY = (self.lineView.st_top - leftH) / 2;
        ...
        [_buttonLeft.titleLabel setFont:self.commonFont];
...
//        CGFloat rightY = self.buttonLeft.st_y;
        CGFloat rightW = 68;
        CGFloat rightH = 44;
        CGFloat rightX = self.contentView.st_width - rightW ;
        CGFloat rightY = 0;
        ...
        [_buttonRight.titleLabel setFont:self.commonFont];
...
- (UILabel *)labelTitle
{
    if (!_labelTitle) {
        ...
        [_labelTitle setFont:self.commonFont];
